-- Ce script permet de créer les tables d'une base de données MariaDB pour le projet ABCRDV.
...
CREATE TABLE IF NOT EXISTS membres_equipe (
	...
	FOREIGN KEY (professionnel_id) REFERENCES professionnels(professionnel_id)
);
...
CREATE TABLE IF NOT EXISTS professionnel_services (
	professionnel_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS agendas (
	...
	FOREIGN KEY (membre_id) REFERENCES membres_equipe(membre_id)
);
