/*
Executer ce script autant que abcrdv_prd_db-useradm.
...
Il supprime une base de données nommée "abcrdv_prd_db".
...
DROP TABLE IF EXISTS abcrdv_prd_db.reservations;

-- Supprimer la table des avis 
DROP TABLE IF EXISTS abcrdv_prd_db.avis;

-- Suppression de la table des agendas
DROP TABLE IF EXISTS abcrdv_prd_db.agendas;

-- Supprimer la table de liaison entre professionnels et services
DROP TABLE IF EXISTS abcrdv_prd_db.professionnel_services;

-- Supprimer la table des membres d'équipe
DROP TABLE IF EXISTS abcrdv_prd_db.membres_equipe;


-- Supprimer la table des clients
DROP TABLE IF EXISTS abcrdv_prd_db.clients;

-- Supprimer la table des services
DROP TABLE IF EXISTS abcrdv_prd_db.services;

-- Supprimer la table des professionnels
DROP TABLE IF EXISTS abcrdv_prd_db.professionnels;

-- Supprimer la table des villes en dernier
DROP TABLE IF EXISTS abcrdv_prd_db.villes;